...
$msg_javascript16          = 'Which mode do you want to enable? "Test" is for testing ONLY and will not take live payments from your bank. This should be the default until you are sure your store is working.<br><br>IMPORTANT: For Payza you MUST enable test/live mode via your Payza account area.';
...
$msg_javascript250         = 'Live/test payment url for Payza. Unless updated by Payza, this should NOT be changed.';
$msg_javascript251         = 'Your merchant email address for IPN payments. This is set in your Payza account area.';
$msg_javascript252         = 'Your IPN security code. This is set in your Payza account area.';
