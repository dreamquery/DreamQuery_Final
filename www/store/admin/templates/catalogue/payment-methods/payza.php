...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_settings113; ?>: <?php echo mc_displayHelpTip($msg_javascript251,'RIGHT'); ?></label>
  ...
  <div class="formRight">
    <label><?php echo $msg_settings114; ?>: <?php echo mc_displayHelpTip($msg_javascript252); ?></label>
    <input type="password" name="params[ipncode]" value="<?php echo (isset($params['ipncode']) ? mc_safeHTML($params['ipncode']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <br class="clear">
</div>
