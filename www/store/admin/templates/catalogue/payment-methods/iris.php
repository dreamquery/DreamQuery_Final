...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_paymethods2; ?>: <?php echo mc_displayHelpTip($msg_javascript574,'RIGHT'); ?></label>
  ...
  <div class="formRight">
    <label><?php echo $msg_paymethods28; ?>: <?php echo mc_displayHelpTip($msg_javascript575); ?></label>
...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_paymethods38; ?>: <?php echo mc_displayHelpTip($msg_javascript584,'RIGHT'); ?></label>
    <input type="text" name="params[sub-account]" value="<?php echo (isset($params['sub-account']) ? mc_safeHTML($params['sub-account']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
