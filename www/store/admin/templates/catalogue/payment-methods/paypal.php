...
<div class="formFieldWrapper">
  ...
  <div class="formRight">
    ...
    <input type="text" name="params[pagestyle]" value="<?php echo (isset($params['pagestyle']) ? mc_safeHTML($params['pagestyle']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <br class="clear">
</div>
...
<div class="formFieldWrapper">
  <div class="formLeft">
    ...
    <input type="text" name="params[locale]" value="<?php echo mc_safeHTML($params['locale']); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <br class="clear">
</div>
