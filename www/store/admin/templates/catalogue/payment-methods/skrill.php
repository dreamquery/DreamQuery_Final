...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_settings154; ?>: <?php echo mc_displayHelpTip($msg_javascript293,'RIGHT'); ?></label>
    <input type="text" name="params[email]" value="<?php echo (isset($params['email']) ? mc_safeHTML($params['email']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <div class="formRight">
    <label><?php echo $msg_settings155; ?>: <?php echo mc_displayHelpTip($msg_javascript294); ?></label>
    <input type="password" name="params[secret]" value="<?php echo (isset($params['secret']) ? mc_safeHTML($params['secret']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <br class="clear">
</div>
...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_settings153; ?>: <?php echo mc_displayHelpTip($msg_javascript291,'RIGHT'); ?></label>
    <input type="text" name="params[logo]" value="<?php echo ($params['logo'] ? mc_safeHTML($params['logo']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <div class="formRight">
  <label><?php echo $msg_settings156; ?>: <?php echo mc_displayHelpTip($msg_javascript295); ?></label>
  <select name="params[language]">
  <?php
  foreach ($skrillLanguages AS $k => $v) {
  ?>
