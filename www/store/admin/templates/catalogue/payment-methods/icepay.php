...
$skipStatusDisplay = array('cancelled','pending');
...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_paymethods2; ?>: <?php echo mc_displayHelpTip($msg_javascript558,'RIGHT'); ?></label>
  ...
  <div class="formRight">
    <label><?php echo $msg_paymethods31; ?>: <?php echo mc_displayHelpTip($msg_javascript559); ?></label>
    <input type="password" name="params[encryption-code]" value="<?php echo (isset($params['encryption-code']) ? mc_safeHTML($params['encryption-code']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <br class="clear">
</div>
...
<div class="formFieldWrapper">
 ...
 <div class="formRight">
   ...
   <?php
   foreach ($icePayLanguages AS $k => $v) {
   ?>
