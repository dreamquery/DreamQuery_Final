...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_settings45; ?>: <?php echo mc_displayHelpTip($msg_javascript184,'RIGHT'); ?></label>
    <input type="text" name="params[account]" value="<?php echo (isset($params['account']) ? mc_safeHTML($params['account']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <div class="formRight">
    <label><?php echo $msg_settings46; ?>: <?php echo mc_displayHelpTip($msg_javascript183); ?></label>
...
<div class="formFieldWrapper">
 ...
 <div class="formRight">
   ...
   <?php
   foreach ($twoCheckoutLanguages AS $k => $v) {
   ?>
