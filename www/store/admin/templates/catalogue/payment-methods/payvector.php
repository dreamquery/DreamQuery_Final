...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_paymethods2; ?>: <?php echo mc_displayHelpTip($msg_javascript567,'RIGHT'); ?></label>
  ...
  <div class="formRight">
    <label><?php echo $msg_paymethods4; ?>: <?php echo mc_displayHelpTip($msg_javascript568,'LEFT'); ?></label>
...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_paymethods5; ?>: <?php echo mc_displayHelpTip($msg_javascript569,'RIGHT'); ?></label>
