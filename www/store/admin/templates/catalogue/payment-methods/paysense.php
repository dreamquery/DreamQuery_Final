...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_paymethods2; ?>: <?php echo mc_displayHelpTip($msg_javascript507,'RIGHT'); ?></label>
  ...
  <div class="formRight">
    <label><?php echo $msg_paymethods4; ?>: <?php echo mc_displayHelpTip($msg_javascript508,'LEFT'); ?></label>
    <input type="password" name="params[pre-share-key]" value="<?php echo (isset($params['pre-share-key']) ? mc_safeHTML($params['pre-share-key']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <br class="clear">
</div>
...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_payment_methods[11]; ?>: <?php echo mc_displayHelpTip($msg_javascript509,'RIGHT'); ?></label>
    <input type="password" name="params[password]" value="<?php echo (isset($params['password']) ? mc_safeHTML($params['password']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
