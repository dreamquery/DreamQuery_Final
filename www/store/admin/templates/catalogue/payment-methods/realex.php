...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_paymethods2; ?>: <?php echo mc_displayHelpTip($msg_javascript539,'RIGHT'); ?></label>
  ...
  <div class="formRight">
    <label><?php echo $msg_paymethods28; ?>: <?php echo mc_displayHelpTip($msg_javascript540); ?></label>
