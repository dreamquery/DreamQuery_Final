...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_payment_methods[2]; ?>: <?php echo mc_displayHelpTip($msg_javascript567,'RIGHT'); ?></label>
    <input type="text" name="params[site-reference]" value="<?php echo (isset($params['site-reference']) ? mc_safeHTML($params['site-reference']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <br class="clear">
</div>
...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_payment_methods[3]; ?>: <?php echo mc_displayHelpTip($msg_javascript569,'RIGHT'); ?></label>
    <input type="password" name="params[notify-password]" value="<?php echo (isset($params['notify-password']) ? mc_safeHTML($params['notify-password']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <div class="formRight">
    <label><?php echo $msg_payment_methods[4]; ?>: <?php echo mc_displayHelpTip($msg_javascript568,'LEFT'); ?></label>
    <input type="password" name="params[merchant-password]" value="<?php echo (isset($params['merchant-password']) ? mc_safeHTML($params['merchant-password']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <br class="clear">
</div>
