...
$skipStatusDisplay = array('cancelled','pending','refunded');
...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_paymethods2; ?>: <?php echo mc_displayHelpTip($msg_javascript560,'RIGHT'); ?></label>
  ...
  <div class="formRight">
    <label><?php echo $msg_paymethods32; ?>: <?php echo mc_displayHelpTip($msg_javascript561); ?></label>
    <input type="password" name="params[hash-value]" value="<?php echo (isset($params['hash-value']) ? mc_safeHTML($params['hash-value']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <br class="clear">
</div>
...
<div class="formFieldWrapper">
 ...
 <div class="formRight">
   ...
   <?php
   foreach ($beanStreamLanguages AS $k => $v) {
   ?>
