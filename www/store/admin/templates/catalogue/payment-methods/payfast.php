...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_paymethods2; ?>: <?php echo mc_displayHelpTip($msg_javascript501,'RIGHT'); ?></label>
  ...
  <div class="formRight">
    <label><?php echo $msg_paymethods3; ?>: <?php echo mc_displayHelpTip($msg_javascript502); ?></label>
    <input type="password" name="params[merchant-key]" value="<?php echo (isset($params['merchant-key']) ? mc_safeHTML($params['merchant-key']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <br class="clear">
</div>
...
<div class="formFieldWrapper">
 <div class="formLeft">
  <label><?php echo $msg_settings80; ?>: <?php echo mc_displayHelpTip($msg_javascript504,'RIGHT'); ?></label>
    <input type="text" name="sandboxserver" value="<?php echo mc_safeHTML($PM->sandboxserver); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
 </div>
 <div class="formRight">
   <label><?php echo $msg_paymethods30; ?>: <?php echo mc_displayHelpTip($msg_javascript557,'LEFT'); ?></label>
   <input type="text" name="params[validation-sand-url]" value="<?php echo mc_safeHTML($params['validation-sand-url']); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
 </div>
 <br class="clear">
</div>
...
<div class="formFieldWrapper">
  ...
  <div class="formRight">
    <label><?php echo $msg_paymethods24; ?>: <?php echo mc_displayHelpTip($msg_javascript532,'LEFT'); ?></label>
    <input type="text" name="params[validation-url]" value="<?php echo mc_safeHTML($params['validation-url']); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <br class="clear">
</div>
