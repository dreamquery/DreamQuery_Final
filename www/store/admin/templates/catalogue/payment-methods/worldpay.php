...
<div class="formFieldWrapper">
  <div class="formLeft">
    <label><?php echo $msg_paymethods19; ?>: <?php echo mc_displayHelpTip($msg_javascript522,'RIGHT'); ?></label>
    <input type="text" name="params[install-id]" value="<?php echo (isset($params['install-id']) ? mc_safeHTML($params['install-id']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <div class="formRight">
    <label><?php echo $msg_paymethods20; ?>: <?php echo mc_displayHelpTip($msg_javascript523); ?></label>
    <input type="password" name="params[callback-pw]" value="<?php echo (isset($params['callback-pw']) ? mc_safeHTML($params['callback-pw']) : ''); ?>" class="box" tabindex="<?php echo ++$tabIndex; ?>">
  </div>
  <br class="clear">
</div>
