...
class onAccount extends paymentHandler {

  public $gateway_name = 'On Account';
  public $gateway_url;
  public $gateway;
  ...
  public function mailTemplates() {
    $t = array(
      'completed' => 'order-on-account-completed.txt',
      'completed-wm' => 'order-on-account-webmaster.txt',
